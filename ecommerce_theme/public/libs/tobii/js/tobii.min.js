(function(a, b) {
    ...
    return function(a) {
          ...
          , D = {
            image: {
                checkSupport: function(a) {
                    return !a.hasAttribute("data-type") && a.href.match(/\.(png|jpe?g|tiff|tif|gif|bmp|webp|svg|ico)(\?.*)?$/i)
                },
                init: function(a, b) {
                    ...
                    d.appendChild(g),
                    c.captions && ("self" === c.captionsSelector && a.getAttribute(c.captionAttribute) ? f.textContent = a.getAttribute(c.captionAttribute) : "img" === c.captionsSelector && h && h.getAttribute(c.captionAttribute) && (f.textContent = h.getAttribute(c.captionAttribute)),
                    f.textContent && (f.id = "tobii-figcaption-" + e,
                    d.appendChild(f),
            ...
            html: {
                ...
                init: function(a, b) {
                    ...
                    if (!d)
                        throw new Error("Ups, I can't find the target " + c + ".");
                    b.appendChild(d),
                    b.setAttribute("data-type", "html")
                },
                onPreload: function() {},
                onLoad: function(a) {
                    var b = a.querySelector("video");
                    b && (b.hasAttribute("data-time") && 0 < b.readyState && (b.currentTime = b.getAttribute("data-time")),
            ...
            iframe: {
                ...
                init: function(a, b) {
                    ...
                    a.getAttribute("data-width") && (c.style.maxWidth = a.getAttribute("data-width") + "px"),
                    a.getAttribute("data-height") && (c.style.maxHeight = a.getAttribute("data-height") + "px"),
                    b.appendChild(c),
            ...
            youtube: {
                ...
                onLeave: function(a) {
                    1 === w[a.getAttribute("data-player")].getPlayerState() && w[a.getAttribute("data-player")].pauseVideo()
                },
                onCleanup: function(a) {
                    1 === w[a.getAttribute("data-player")].getPlayerState() && w[a.getAttribute("data-player")].pauseVideo()
                }
        ...
        var E = function(a) {
          ...
          , I = function(a, b) {
            if (A = G(a),
            Object.prototype.hasOwnProperty.call(z, A) || (z[A] = H(y),
            L()),
            -1 === z[A].gallery.indexOf(a)) {
                if (z[A].gallery.push(a),
                z[A].elementsLength++,
          ...
          , N = function(a, b) {
            ...
            c.hideScrollbar && (document.documentElement.classList.add("tobii-is-open"),
            document.body.classList.add("tobii-is-open")),
            na(),
            c.close || (i.disabled = !1,
          ...
          , O = function(a) {
            ...
            c.hideScrollbar && (document.documentElement.classList.remove("tobii-is-open"),
          ...
          , R = function(a) {
            0 < z[B].currentIndex && (T(z[B].currentIndex),
            Q(--z[B].currentIndex),
            pa("left"),
          ...
          , S = function(a) {
            z[B].currentIndex < z[B].elementsLength - 1 && (T(z[B].currentIndex),
            Q(++z[B].currentIndex),
            pa("right"),
            U(z[B].currentIndex - 1),
            P(z[B].currentIndex + 1),
          ...
          , X = function(a) {
            ...
            1 === z[B].elementsLength ? (g.disabled = !0,
            h.disabled = !0,
            c.close && i.focus()) : (0 === z[B].currentIndex && (g.disabled = !0,
            h.focus()),
            z[B].currentIndex === z[B].elementsLength - 1 && (h.disabled = !0,
            g.focus()))) : c.close && i.focus(),
          ...
          , Z = function() {
            var a = k.endX - k.startX
              ...
              , e = b(a)
              , f = b(d);
            0 < a && e > c.threshold && 0 < z[B].currentIndex ? R() : 0 > a && e > c.threshold && z[B].currentIndex !== z[B].elementsLength - 1 ? S() : 0 > d && f > c.threshold && c.swipeClose ? O() : V()
        }
          , $ = function() {
            t || (t = !0,
          ...
          , _ = function(a) {
            a.preventDefault(),
            B = G(this),
            N(z[B].gallery.indexOf(this))
        }
          , aa = function(a) {
            a.target === g ? R() : a.target === h ? S() : (a.target === i || "tobii__slider-slide" === a.target.className && c.docClose) && O(),
            a.stopPropagation()
        }
          , ba = function(a) {
            9 === a.keyCode || "Tab" === a.code ? a.shiftKey ? document.activeElement === p && (q.focus(),
            a.preventDefault()) : document.activeElement === q && (p.focus(),
            a.preventDefault()) : 27 === a.keyCode || "Escape" === a.code ? (a.preventDefault(),
            O()) : 37 === a.keyCode || "ArrowLeft" === a.code ? (a.preventDefault(),
            R()) : (39 === a.keyCode || "ArrowRight" === a.code) && (a.preventDefault(),
            S())
        }
          , ca = function(a) {
            ta(a.target) || (a.stopPropagation(),
            n = !0,
          ...
          , ia = function() {
            var a = Math.round;
            0 < b(k.startX - k.endX) && !m && c.swipeClose ? (z[B].slider.style.transform = "translate3d(" + (s - a(k.startX - k.endX)) + "px, 0, 0)",
            l = !0,
            m = !1) : 0 < b(k.startY - k.endY) && !l && (z[B].slider.style.transform = "translate3d(" + s + "px, -" + a(k.startY - k.endY) + "px, 0)",
            l = !1,
            m = !0)
        }
          , ja = function() {
            ...
            c.draggable && (sa() && (f.addEventListener("touchstart", ca),
          ...
          , ka = function() {
            ...
            c.draggable && (sa() && (f.removeEventListener("touchstart", ca),
          ...
          , na = function() {
            c.draggable && 1 < z[B].elementsLength && !z[B].slider.classList.contains("tobii__slider--is-draggable") && z[B].slider.classList.add("tobii__slider--is-draggable"),
            !c.nav || 1 === z[B].elementsLength || "auto" === c.nav && sa() ? (g.setAttribute("aria-hidden", "true"),
            h.setAttribute("aria-hidden", "true")) : (g.setAttribute("aria-hidden", "false"),
            h.setAttribute("aria-hidden", "false")),
            c.counter && 1 !== z[B].elementsLength ? j.setAttribute("aria-hidden", "false") : j.setAttribute("aria-hidden", "true")
        }
          , oa = function() {
            for (var a in z)
                Object.prototype.hasOwnProperty.call(z, a) && (z[a].slider.style.display = B === a ? "block" : "none")
        }
          , pa = function(a) {
            oa(),
            V(),
          ...
          , ta = function(a) {
            return -1 !== ["TEXTAREA", "OPTION", "INPUT", "SELECT"].indexOf(a.nodeName) || a === g || a === h || a === i || 1 === z[B].elementsLength
        }
          , ua = function() {
